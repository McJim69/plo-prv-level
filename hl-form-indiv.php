		...
		<div class="card-glass p-3">
			<div class="row g-3 align-items-center justify-content-between">
				...
				<div class="col-md-3 d-flex align-items-center gap-1 justify-content-end">
					<a href="hl-form-all.php?barangay=ABONG-ABONG" class="btn btn-outline-danger"><i class="fa fa-list"></i> All Barangay Form</a>
				</div>
			</div>
		</div>
	</div>
...
<div class="padding-bottom:0 !important; main-content container print-container" style="max-width: 1000px; background: #fff; border-radius: var(--radius-md); box-shadow: var(--shadow-md);">
	<?php
